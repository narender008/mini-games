// Loader: checks for WebGL 2, downloads the engine and game code with a
...
async function boot() {
  ...
  if (!probe.getContext('webgl2')) {
    fail('Garden Grow needs WebGL 2, which this browser or device does not provide. Try an up-to-date Chrome, Edge, Firefox or Safari.');
    return null;
  }
