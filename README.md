...
| [Splash Ride](games/splash-ride/) | Drive a little boat across photoreal water: it moves on its own and you just steer, leaving spray and a foamy wake, hopping over gentle wave bumps with a splash, racing dolphins and driving through sparkle rings. Bumping a rock or the shore is a soft bumper-boat bounce, and nobody can lose. Four places (a Tropical Lagoon, a Sunset Lake, a Canal Town with bridges to pass under and a Glowing Night Bay with fireflies and lanterns) and four boats (a speedboat, a wooden sailboat, a rubber-duck boat and a jet ski). Little ones (hold the left or right side of the screen, or tilt the tablet like a steering wheel) and Big kid (drag, an on-screen wheel or the arrow keys, a boost and a horn, shells to find, wave ramps, and a buoy course in every place that races a ghost of your best run). |
